...
Future<SelectionPlayer> initService() async {
  await copyPlayerNotificationIconToAppFolder();
  return await AudioService.init(
    builder: () => SelectionPlayer(),
...
class SelectionPlayer extends AudioPlayerHandler {
  ...
  Future<void> playSound(MediaInfo mediaInfo, int readerId, int soraNum,
    ...
    this.currentPlayingSoraNum=soraNum;
    ...
    notificationMediaItem = MediaItem(
        ...
        // artUri: Uri.parse('https://noorinternational.net/articles/What-do-you-know-about-the-Quran/assets/images/quran-1.jpg'),
  ...
  @override
  audioSourceCompletedOrStopped() async {
  ...
  Future<void> stopAudio() async {
    print("from selection player >>> Future<void> stopAudio()");
