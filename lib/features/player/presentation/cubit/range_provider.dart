...
class RangeProvider extends ChangeNotifier {
  ...
  int? _startIndex=0, _endIndex=2, _selectedIndex,_count;

  List<GlobalKey<State<StatefulWidget>>> get keys => _keys==null? [] : _keys;
  ...
  set count(int? value) {
    _count = value;
    _keys = List<GlobalKey>.generate(value!, (index) => GlobalKey());
    _boxDetails = List.filled(value!, OffsetDetails(xf: null, xe: null, yf: null, ye: null));
    notifyListeners();
  }
